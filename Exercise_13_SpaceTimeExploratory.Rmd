...
```{r}
dxt = diff(xt)
dxt1 = diff(xt, differences=1)
dxt2 = diff(xt, differences=2)
dxt3 = diff(xt, differences=3)
dxt4 = diff(xt, differences=4)
par(mfrow = c(4,2))
plot(dxt1); hist(dxt1,10)
plot(dxt2); hist(dxt2,10)
plot(dxt3); hist(dxt3,10)
plot(dxt4); hist(dxt4,10)
```
